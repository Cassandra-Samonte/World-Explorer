...
export default function commentSection({ countryId }) {
    ...
    // Query the database for all comments that pertain to this country
    useEffect(() => {
    ...
    function handleSubmit(event) {
        ...
        postComment({ ...createFormData, countryId: countryId })
